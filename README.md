...
2. Encrypt or decrypt with Vigenère cipher
3. Save result to output file
4. Compare text statistics before and after transformation

### Frequency analysis includes
* top 3 most common letters/digits
* top 3 least common letters/digit
